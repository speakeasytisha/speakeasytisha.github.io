// Airport SFO – Full Interactive Lesson (Beginner)
(function () {
  "use strict";
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    mcButtons.forEach((btn) => {
      btn.addEventListener("click", function () {
        ...
        // Prevent changing score after correct
        if (item.dataset.scored === "true") {
          return;
        }
    ...
    function setupChoiceBuilder(builderName, previewId, resetId, stepOrder) {
      ...
      function handleStep(step) {
        ...
        if (!allValid) {
          handleIncorrect(
            ...
            step.dataset.hintWrong ||
              "❌ One of the options doesn’t sound natural here. Check country, reason or length of stay."
          );
          return;
        }
        ...
        setFeedback(
          step,
          "✅ Great! This line has been added to your dialogue.",
          true
        );
      }
    ...
    const customsBuilder = setupChoiceBuilder(
      "customs",
      "customs-preview",
      "customs-reset",
      ["c1", "c2", "c3"]
    );
    if (customsBuilder) builders.push(customsBuilder);
