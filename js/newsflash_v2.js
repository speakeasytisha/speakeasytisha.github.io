...
(function () {
  ...
  const NEWS = [
    {
      ...
      region:"World",
      date:"2026-03-03",
      title:"Middle East conflict disrupts shipping; leaders discuss protecting civilian lives",
      brief:"Shipping disruption and regional conflict raise concerns about costs, energy, and stability.",
      full:{
        A2:{summary:"There is a serious conflict in the Middle East. Shipping routes are disrupted, and prices can rise. People worry about safety and daily costs.",
          facts:["The conflict affects shipping routes.","Disruption can raise transport and energy costs.","People follow updates because the situation can change quickly."],
          vocab:["shipping","disruption","ceasefire","escalation","inflation"],
          grammar:{focus:"Timeline trio",patterns:["Present: Prices rise when supply is limited.","Past: Leaders spoke about the situation.","Past continuous: While ships were waiting, costs were increasing."],
            mini:"Use <span class='kbd'>while</span> for background + <span class='kbd'>then</span> for the main event."},
          tasks:["Speak 30 seconds: what happened / what was happening / what is true now.","Write 5 headline-style sentences (present simple).","Add 2 connectors: However / As a result."]},
        B1:{summary:"Regional conflict has disrupted some shipping, creating uncertainty about costs and supply. Leaders are discussing ways to protect civilian lives and stabilize the situation.",
          facts:["Disrupted routes can affect supply chains and prices.","Officials are holding talks with regional partners.","Uncertainty can affect markets and public opinion."],
          vocab:["supply chain","volatility","negotiations","deterrence","disruption"],
          grammar:{focus:"Past continuous + past simple",patterns:["While routes were being disrupted, costs increased.","Officials issued statements and markets reacted."],
            mini:"Background = <span class='kbd'>was/were + -ing</span>. Turning point = past simple."},
          tasks:["Roleplay: anchor + fact-checker (balanced language).","Write a short paragraph with 2 cautious phrases (reportedly / according to).","Create 3 questions to ask a witness (neutral tone)."]},
        B2:{summary:"Disruption in shipping linked to regional conflict has intensified uncertainty around supply, prices, and political risk. Leaders are discussing protective measures while the situation remains fluid.",
          facts:["Shipping disruption can push up costs and pressure policymakers.","Diplomatic talks are continuing alongside security concerns.","Public debate often mixes facts and opinions—use cautious language."],
          vocab:["deterrence","accountability","volatility","escalation","sanctions"],
          grammar:{focus:"Hedging + balance",patterns:["It appears that…","According to officials…","However, key details remain unclear."],
            mini:"Avoid strong claims. Prefer <span class='kbd'>may / might / appears</span>."},
          tasks:["Write a 120–150 word news brief with 1 passive sentence.","Debate: ‘Costs vs security’ (balanced arguments).","Build a timeline with 3 connectors (Meanwhile / However / As a result)."]}
      }
    },
    {
      id:"ukraine_talks",
      region:"Europe",
      date:"2026-03-02",
      title:"Ukraine-Russia talks still expected this week, Zelenskiy says",
      brief:"Diplomacy continues despite wider security tensions; uncertainty remains.",
      full:{
        A2:{summary:"Ukraine and Russia are still in conflict. Leaders say talks may happen soon. People want peace, but it is complicated.",
          facts:["There is still a war in Ukraine.","Talks may happen soon, but nothing is certain.","People follow the news because the situation changes."],
          vocab:["ceasefire","negotiations","sanctions","investigation","evidence"],
          grammar:{focus:"Present vs past",patterns:["Now: Talks continue.","Earlier: Officials announced plans.","While: People were watching the news."],
            mini:"Use <span class='kbd'>now / earlier / while</span> to guide the listener."},
          tasks:["Speak: 3-sentence timeline (now/earlier/while).","Write: a friendly message to a friend about the news (neutral).","Connector challenge: However / Meanwhile."]},
        B1:{summary:"U.S.-brokered talks are still expected, according to Ukrainian officials, even as wider security tensions affect the context. The situation remains uncertain, and timelines can change.",
          facts:["Officials say talks have not been cancelled.","Security developments can affect diplomacy.","Use cautious language when details are unconfirmed."],
          vocab:["negotiations","ceasefire","deterrence","escalation","accountability"],
          grammar:{focus:"Cautious reporting",patterns:["Officials said…","It is expected that…","Details have not been confirmed."],
            mini:"Use reporting verbs: <span class='kbd'>said / stated / reported</span>."},
          tasks:["Roleplay: journalist interviewing an analyst.","Write a 90–120 word ‘neutral update’.","Create 5 ‘fact vs opinion’ statements."]},
        B2:{summary:"Statements from Ukrainian leadership suggest planned talks remain on the agenda despite heightened regional tensions. Any timeline should be framed cautiously, distinguishing confirmed details from expectations.",
          facts:["Peace talks can be delayed or reshaped by external events.","Reporting should separate ‘planned’ from ‘confirmed’.","Use balanced framing to avoid overclaiming."],
          vocab:["deterrence","sanctions","volatility","escalation","negotiations"],
          grammar:{focus:"Precision",patterns:["The meeting is scheduled to…","The parties have not confirmed…","However, the venue remains uncertain."],
            mini:"Prefer <span class='kbd'>scheduled / expected / reported</span> over ‘will’."},
          tasks:["Write: 150-word mini-article with headline + lead.","Add 2 passive forms (was announced / were discussed).","Speak: 60 seconds using hedging + connectors."]}
      }
    },
    {
      id:"fr_budget",
      region:"France",
      date:"2026-02-03",
      title:"France adopts 2026 budget after PM survives no-confidence votes",
      brief:"After political tension, France adopted a 2026 budget following parliamentary procedures.",
      full:{
        A2:{summary:"In France, the government had important votes. The Prime Minister stayed in power, and the budget was adopted.",
          facts:["There were no-confidence votes.","The government survived the votes.","A 2026 budget was adopted."],
          vocab:["budget","vote","majority","coalition","policy"],
          grammar:{focus:"Past simple",patterns:["They voted.","The government survived.","The budget passed."],
            mini:"Use <span class='kbd'>yesterday / last week / in 2026</span> for past simple."},
          tasks:["Speak: 5 short past sentences.","Write: a simple ‘what happened’ paragraph.","Use 3 vocab words in one sentence."]},
        B1:{summary:"France adopted a 2026 budget after the Prime Minister survived no-confidence votes. The episode shows how political coalitions and parliamentary procedures shape decisions.",
          facts:["No-confidence votes attempted to bring down the government.","The government survived and the budget passed.","Political bargaining influences budgets."],
          vocab:["no-confidence vote","coalition","majority","budget","accountability"],
          grammar:{focus:"Cause/effect connectors",patterns:["As a result, …","However, …","Therefore, …"],
            mini:"Use connectors to explain political impact."},
          tasks:["Roleplay: explain the vote to a friend.","Write: 120 words with 3 connectors.","Create 5 ‘why it matters’ points."]},
        B2:{summary:"The adoption of France’s 2026 budget followed a tense parliamentary sequence in which the Prime Minister survived no-confidence motions. The outcome highlights coalition dynamics, fiscal choices, and accountability debates.",
          facts:["Surviving motions preserved the government’s ability to pass the budget.","Budgets reflect political compromise and fiscal constraints.","Journalistic writing benefits from neutral, precise language."],
          vocab:["coalition","majority","accountability","policy","volatility"],
          grammar:{focus:"Neutral political reporting",patterns:["Lawmakers voted to…","The motion failed to…","The budget was adopted after…"],
            mini:"Use passive to focus on process: <span class='kbd'>was adopted / was rejected</span>."},
          tasks:["Write: 160 words with lead + 3 facts + one quote (invented but labeled ‘quote’).","Speak: 60 seconds explaining the timeline.","Translate 5 key terms to French (optional)."]}
      }
    },
    {
      id:"epstein_settlement",
      region:"USA",
      date:"2026-03-03",
      title:"Judge preliminarily approves $35M settlement linked to Epstein estate advisers",
      brief:"A judge gave preliminary approval to a settlement connected to claims against former advisers; a final hearing is scheduled later.",
      full:{
        A2:{summary:"A judge approved a settlement linked to the Epstein case. Some documents are still being reviewed. Many details are sensitive, so we use careful language.",
          facts:["A settlement was approved (preliminary).","There will be another hearing later.","Some files are still under review / redacted."],
          vocab:["investigation","evidence","witness","redacted","accountability"],
          grammar:{focus:"Passive voice (simple)",patterns:["A settlement was approved.","Documents were released."],
            mini:"Passive = focus on action, not who did it."},
          tasks:["Speak: neutral update (no opinions).","Write: 6 passive sentences.","Choose 3 vocab words and define them."]},
        B1:{summary:"A settlement related to claims against two of Epstein’s former advisers received preliminary approval from a judge. Separately, officials say many documents remain under review, and releases can include redactions.",
          facts:["Preliminary approval is not final approval.","Some records can be redacted for legal/safety reasons.","Journalistic language should be factual and cautious."],
          vocab:["settlement","preliminary","redacted","investigation","accountability"],
          grammar:{focus:"Cautious phrasing",patterns:["According to court filings…","A judge preliminarily approved…","Details remain unclear."],
            mini:"Use <span class='kbd'>preliminarily</span> to avoid overclaiming."},
          tasks:["Write: 120 words with 2 reporting verbs (said/reported).","Fact-check drill: separate confirmed vs unconfirmed lines.","Speaking: explain why ‘redacted’ matters (B1)."]},
        B2:{summary:"Court proceedings connected to Epstein-related claims continue, including preliminary approval of a settlement involving alleged conduct by former advisers. Parallel debates focus on transparency, redactions, and accountability, requiring careful sourcing and language.",
          facts:["Preliminary approval precedes a final approval hearing.","Redactions can protect victims and ongoing investigations.","Journalistic ethics prioritize accuracy and sensitivity."],
          vocab:["accountability","redacted","evidence","investigation","settlement"],
          grammar:{focus:"Journalistic register",patterns:["The court heard…","Documents were filed…","However, the record remains incomplete."],
            mini:"Use neutral verbs: <span class='kbd'>allege / deny / state</span>."},
          tasks:["Write: 150–180 words with headline + lead + 3 facts.","Rewrite 3 sentences to make them more neutral.","Speaking: 60 seconds with hedging + passive voice."]}
      }
    }
  ];
  ...
  function showFullBrief(){ if(els.fullBrief) els.fullBrief.hidden=false; }
  function hideFullBrief(){ if(els.fullBrief) els.fullBrief.hidden=true; }
  function showFBTab(tab){
    if(!els.fullBrief) return;
    const btns = Array.from(els.fullBrief.querySelectorAll('.tabBtn'));
    const panes = Array.from(els.fullBrief.querySelectorAll('.fbPane'));
    btns.forEach(b=>b.setAttribute('aria-selected', b.getAttribute('data-tab')===tab ? 'true':'false'));
    panes.forEach(p=>{ p.hidden = p.getAttribute('data-pane')!==tab; });
  }
  function populateFullBrief(n){
    if(!els.fullBrief) return;
    const level = app.level;
    const data = (n.full && n.full[level]) ? n.full[level] : null;
    if(!data){ if(els.fbMeta) els.fbMeta.textContent='No full brief available for this level.'; return; }
    if(els.fbMeta) els.fbMeta.textContent = `${n.date} — ${n.region} • Level ${level}`;
    const pane = (key)=>els.fullBrief.querySelector(`.fbPane[data-pane="${key}"]`);
    pane('sum').innerHTML = `<b>${escapeHTML(n.title)}</b><br><br>${escapeHTML(data.summary)}`;
    pane('facts').innerHTML = `<b>Key facts</b><ul class="fbList">${data.facts.map(f=>`<li>${escapeHTML(f)}</li>`).join('')}</ul>`;
    pane('vocab').innerHTML = `<b>Vocabulary to use</b><div class="fbGrid">${data.vocab.map(w=>`<div class="fbCard">${escapeHTML(w)}<div class="hint small">Try it in a sentence</div></div>`).join('')}</div>`;
    pane('grammar').innerHTML = `<b>Grammar focus: ${escapeHTML(data.grammar.focus)}</b><ul class="fbList">${data.grammar.patterns.map(s=>`<li>${s}</li>`).join('')}</ul><div class="hint small">Tip: ${data.grammar.mini}</div>`;
    pane('tasks').innerHTML = `<b>Talk / write like a journalist</b><ul class="fbList">${data.tasks.map(t=>`<li>${escapeHTML(t)}</li>`).join('')}</ul>`;
    showFullBrief();
    showFBTab('sum');
  }
...
Connector challenge: add “However / Meanwhile / As a result”.`;
  ...
  // Full Brief panel events
  if(els.fullBrief){
    Array.from(els.fullBrief.querySelectorAll('.tabBtn')).forEach(b=>{
      b.addEventListener('click',()=>showFBTab(b.getAttribute('data-tab')));
    });
  }
  if(els.fbCloseBtn){ els.fbCloseBtn.addEventListener('click', hideFullBrief); }
  if(els.fbReadBtn){ els.fbReadBtn.addEventListener('click', ()=>{
    const pane = els.fullBrief ? els.fullBrief.querySelector('.fbPane[data-pane="sum"]') : null;
    const t = pane ? pane.textContent.trim() : '';
    if(t) speak(t);
  }); }
  if(els.fbCopyBtn){ els.fbCopyBtn.addEventListener('click', async ()=>{
    const t = els.fullBrief ? els.fullBrief.textContent.trim() : '';
    if(!t) return;
    try{ await navigator.clipboard.writeText(t); els.fbCopyBtn.textContent='Copied ✅'; setTimeout(()=>els.fbCopyBtn.textContent='Copy',900);}catch(e){ els.fbCopyBtn.textContent='Copy failed'; setTimeout(()=>els.fbCopyBtn.textContent='Copy',900);} 
  }); }
