...
window.__INTRO_DATA__ = {
      ...
      "slides":[{"n":1,"lines":["🏨","▶ Start Lesson","– GETTING TO KNOW EACH OTHER–","🧳","✈️","🗺️","INTRODUCTION","– ENGLISH LESSON –","📞","LEARNER: FRANKIE DUMARQUEZ | DURATION: 60 MIN | FOCUS: INTRODUCTIONS, GREETINGS, COMMUNICATION NEEDS"]},
              {"n":2,"lines":["FRANKIE","“Hello Tisha! Nice to meet you!”","💬","How are you today?","😊😴😄 to say how you feel today.","👶 Do you have children?","🏠 How many people are in your family?","🐶🐱 Do you have any pets?","🗓️ What do you do on weekends?","🎨🎵🏃‍♀️ What do you do in your free time?"]},
              ...
              {"n":4,"lines":["A WARM WELCOME: OBJECTIVES","– “GETTING TO KNOW EACH OTHER” –","FRIENDLY, RELAXED ATMOSPHERE 😊","START USING ENGLISH NATURALLY AND CONFIDENTLY 🗣️","SIMPLE INTRODUCTIONS AND GREETINGS 🤝","UNDERSTAND, REACT, AND PRONOUNCE 👂","FEEL COMFORTABLE SPEAKING💬","CONFIRM COURSE TOPICS 🧭"]},
                ...
                {"n":5,"lines":
                 ["METHOD: ENGLISH WITH TISHA",
                  ...
                  "Everyone learns differently: some people learn by LOOKING 👁️, LISTENING 👂, READING/WRITING ✍️, SPEAKING/REPEATING 🗣️, DOING/PRACTICING 👐.",
                  "MATERIALS:  PICTURES, SHORT TEXTS, AUDIO, WHATEVER I CAN FIND!  WE PRACTICE GRAMMAR, VOCABULARY, PRONUNCIATION AND EXPRESSIONS, Dialogues, Role-Play"]},
