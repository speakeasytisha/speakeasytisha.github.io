...
window.__INTRO_DATA__ = {
      ...
      "slides":[{"n":1,"lines":["🏨","▶ Start Lesson","– GETTING TO KNOW EACH OTHER–","🧳","✈️","🗺️","INTRODUCTION","– ENGLISH LESSON –","📞","LEARNER: FRANKIE DUMARQUEZ | DURATION: 60 MIN | FOCUS: INTRODUCTIONS, GREETINGS, COMMUNICATION NEEDS"]},
              ...
              {"n":17,"lines":["HOW TO ADDRESS PEOPLE IN ENGLISH","Situation","Title","Example","Register","Man","Mr + last name","Mr Smith","man (formal)","Woman","Mrs + last name","Mrs Johnson","married woman (formal)","Woman/Young Woman","Miss + last name","Miss Brown","unmarried woman (formal)","Woman","Ms + last name","Ms Clark","neutral (formal)","Child / Teen","First name only","Hi Tom!","Casual","Group / Plural","Ladies and gentlemen / everyone / guys","Hello everyone!","Varies by context"]},
